...
<body>
<div class="pen-title">
    <p><img src="/logo-s.png"><h2 style="color:darkcyan;font-size: 20px;">Thank you, the new garage has been added. </h2></p></div>
"""
...
def write_to_google_doc(garage_id, garage_url):
...
def write_to_garage_info_file(garage_id, garage_url):
    ...
    if int(garage_id) in garage_dict:
        ...
        return
    string = "\n"+str(garage_id)+" "+str(garage_url)
    with open("garage_names", "a") as myfile:
        myfile.write(string)
    
write_to_google_doc(garage_id, garage_url)
write_to_garage_info_file(garage_id, garage_url)
